...
contiguous subarrays, followed by XOR-ing the values thus obtained. Can you help
her in this task?

Note : [5,7,5][5,7,5] is contiguous subarray of [4,5,7,5][4,5,7,5]
       while [4,7,5][4,7,5] is not.
